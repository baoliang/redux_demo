...
ActiveRecord::Schema.define(version: 20151208091739) do
  ...
  create_table "spree_order_stock_locations", force: :cascade do |t|
    ...
    t.integer  "stock_location_id",  limit: 4
    t.boolean  "shipment_fulfilled", limit: 1, default: false, null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "spree_orders", force: :cascade do |t|
    ...
    t.boolean  "frontend_viewable",      limit: 1,                              default: true,    null: false
  end
  ...
  create_table "spree_prices", force: :cascade do |t|
    ...
    t.string   "currency",   limit: 255
    t.datetime "deleted_at"
    t.boolean  "is_default", limit: 1,                            default: true, null: false
  end
  ...
  create_table "spree_promotions", force: :cascade do |t|
    ...
    t.boolean  "apply_automatically",   limit: 1,   default: false
  end
  ...
  create_table "spree_stock_locations", force: :cascade do |t|
    ...
    t.string   "admin_name",              limit: 255
    t.integer  "position",                limit: 4,   default: 0
    t.boolean  "restock_inventory",       limit: 1,   default: true,  null: false
    t.boolean  "fulfillable",             limit: 1,   default: true,  null: false
    t.string   "code",                    limit: 255
    t.boolean  "check_stock_on_transfer", limit: 1,   default: true
  end
